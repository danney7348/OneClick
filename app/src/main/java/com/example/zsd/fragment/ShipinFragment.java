...
public class ShipinFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = View.inflate(getContext(), R.layout.shipin_fragment,null);
        return view;
    }
    ...
    private void initView() {
        final TabLayout tl = view.findViewById(R.id.shipin_timeline_tablayout);
        tl.post(new Runnable() {
            @Override
            public void run() {
                setIndicator(tl, 60, 60);
            }
        });
        ViewPager xq_vp = view.findViewById(R.id.shipin_timeline_viewpager);
