...
import com.example.zsd.activity.FaxianLoginActivity;
...
public class FaxianFragment extends BaseFragment {
    ...
    public int getViewId() {
        return R.layout.faxian_fragment_view;
    }
    ...
    public void initFragment() {
        ...
        mSignUpBtn = (Button) view.findViewById(R.id.ec_btn_sign_up);
        ...
        mSignInBtn = (Button) view.findViewById(R.id.ec_btn_sign_in);
            ...
            public void onSuccess() {
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        // 登录成功跳转界面
                        Intent intent = new Intent(getActivity(), FaxianLoginActivity.class);
