...
public class RoView extends ImageView {
    ...
    // 构造函数
    public RoView(Context context) {
        super(context);
        init();
    }

    // 构造函数
    public RoView(Context context, AttributeSet attrs) {
     ...
     * 构造函数
     */
    public RoView(Context context, AttributeSet attrs, int defStyle) {
